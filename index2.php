...
<body>
  ...
  <nav id="nav" class="showNav">
  	<ul>
        ...
        <li class="aboutBtn"><a href="#second" title="ABOUT ME">About Me</a></li>
        <li class="webBtn"><a href="#third" title="WEB DESIGN">Web Design</a></li>
        <li class="mobileBtn"><a href="#fourth" title="MOBILE WEB DESIGN">Mobile Web Design</a></li>
        <li class="advertBtn"><a href="#fifth" title="ADVERTISING">Advertising</a></li>
        <li class="multiBtn"><a href="#sixth" title="MULTIMEDIA">Multimedia</a></li>
        <li class="printBtn"><a href="#seventh" title="PRINT DESIGN">Print Design</a></li>
  ...
  <div id="main" role="main">
    	...
    	<article>
           <div class="main_content">  
                 ...
                 <div class="slider">
                  <div class="slider-wrapper theme-default">
                    <div id="slider" class="nivoSlider">
                        ...
                        <img src="images/slider/img08.jpg" data-thumb="images/slider/img08.jpg" alt="WoundedWarrior Picturee" data-transition="slideInRight" />
               ...
               <div class="info marginTop10px">       
                  <div class="pg_title">
                    <p><img src="images/about-me.png" alt="About Me Title" /></p>
    ...
    <section id="third" class="story" data-speed="6" data-type="background" data-offsetY="250">
      <div class="web-page-container">	
        <div class="web-container stillwaterPos">
        ...
        <div class="web-container cssZenPos">
        	<div class="cssZen" data-type="sprite" data-offsetY="10" data-Xposition="1%" data-speed="2">
            	<div class="webLnkBtn"><h3>CSS Zen Garden Website</h3><a href="http://www.allinharmon.com/webdesign/cssZen/" target="blank">View Site</a>
                </div>
            </div>
        </div>
      </div>
		...
		<div class="advert">
          <div class="galleria-border">
			<div id="galleria">
                ...
                <img src="images/advertising/alienware-ping.jpg" alt="Alienware Ping Page">
                <img src="images/advertising/alienware-popup.jpg" alt="Alienware Pop Up Page">
                ...
                <img src="images/advertising/fah-mobile.jpg" alt="FAH Mobile Page">
                <img src="images/advertising/fah-case-study1.jpg" alt="FAH Case Study Pt 1 Page">
                <img src="images/advertising/fah-case-study2.jpg" alt="FAH Case Study Pt 2 Page">
                ...
                <img src="images/advertising/falcons-mailer.jpg" alt="Falcons Mailer Page">
                <img src="images/advertising/falcons-kit.jpg" alt="Falcons Promo Kit Page">
                <img src="images/advertising/falcons-mobile.jpg" alt="Falcons Mobile Page">
                <img src="images/advertising/falcons-case-study.jpg" alt="Falcons Study Page">
                ...
                <img src="images/advertising/lego-blog.jpg" alt="Lego Student Blog Page">
                <img src="images/advertising/advil-intro.jpg" alt="Advil Intro Page">
                <img src="images/advertising/advil-print-ad.jpg" alt="Advil Print Ad Page">
                <img src="images/advertising/advil-radio.jpg" alt="Advil Radio Page">
                <img src="images/advertising/advil-popup.jpg" alt="Advil Pop Up Page">
                <img src="images/advertising/advil-advergaming.jpg" alt="Advil Advergaming Page">
                <img src="images/advertising/wwaa-intro.jpg" alt="Wounded Warrior Intro Page">
                <img src="images/advertising/wwaa-site.jpg" alt="Wounded Warrior Auction Site Page">
                <img src="images/advertising/wwaa-mobile.jpg" alt="Wounded Warrior Mobile Page">
                <img src="images/advertising/wwaa-popup.jpg" alt="Wounded Warrior Pop Up Page">
                <img src="images/advertising/wwaa-print-ad.jpg" alt="Wounded Warrior Print Ad Page">
                ...
                <img src="images/advertising/marta-commercial.jpg" alt="MARTA Commercial Page">
                <img src="images/advertising/marta-site.jpg" alt="MARTA Site Page">
    ...
    <section id="sixth" class="story" data-speed="6" data-type="background" data-offsetY="450">
      ...
      <div class="multimedia-page-container">	
        ...
        <div class="multimedia-container project3-pos">
        	<div class="project3">
            	<div class="project-title projLnkBtn"><h3>Spot the Difference Game</h3><a href="http://www.allinharmon.com/multimedia/project3.html" target="blank">Play Game</a></div>
            </div>
        </div>
		...
		<div class="advert">
          <div class="galleria-border">
			<div id="galleria2">
                ...
                <img src="images/print-design/photoshop5.jpg" alt="Album Cover">
                ...
                <img src="images/print-design/illust_3_2.jpg" alt="ComicCon Banner">      
                <img src="images/print-design/illust_3_3.jpg" alt="ComicCon Ticket">      
